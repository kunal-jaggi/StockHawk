...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    /*
        ...
        use to determine why they aren't seeing stock data.
     */
    private void updateEmptyView() {
        if (mCursorAdapter.getItemCount() == 0) {
            ...
            if (null != emptyView) {
                // if cursor is empty, why? do we have an invalid stock quote
                int message = R.string.empty_stock_list;

                @StockTaskService.StockStatus int location = Utils.getStockStatus(this);
                switch (location) {
    ...
    public void networkToast() {
        TextView emptyView = (TextView) findViewById(R.id.empty_view);
        emptyView.setText(R.string.empty_stock_list_no_network);
        emptyView.setVisibility(View.VISIBLE);
